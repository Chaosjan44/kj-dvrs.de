    ...
    if ($_POST['action'] == 'register') {
        if(isset($_POST['user']) && !empty($_POST['user']) && isset($_POST['passwort']) && !empty($_POST['passwort']) && isset($_POST['passwort2']) && !empty($_POST['passwort2']) && isset($_POST['vorname']) && !empty($_POST['vorname']) && isset($_POST['nachname']) && !empty($_POST['nachname'])) {
            if ($_POST['passwort'] == $_POST['passwort2']) {
                ...
                $stmt = $pdo->prepare("INSERT INTO users SET login = ?, password = ?, nachname = ?, vorname = ?, email = ?, kolpingjugend_id = ?, perm_login = ?, perm_admin = ?");
                ...
                <div class="card-body">
                    ...
                    <div class="card-text">
                        ...
                        <form action="register.php" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input id="inputEmail" type="text" name="email" placeholder="E-Mail" autofocus class="form-control border-0 ps-4 text-dark fw-bold" required>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="kj_id" class="text-dark fw-bold">Kolpingjugend</label>
                            </div>
                            <div class="col mb-3">
